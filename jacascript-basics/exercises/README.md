...
Look at the different display examples and execute them by opening the files on your local computer.
  ...
  - [Writing into the browser console](../examples/display_console.html)
  - [Writing into an alert box](../examples/display_alert.html)
  - [Writing into the HTML output](../examples/display_document.html)
...
## Exercise #3b: Prompting values
  ...
  - Extend the previous exercise such that the integers `a` and `b` are entered by  the user.  Use the [prompt()](https://developer.mozilla.org/en-US/docs/Web/API/Window/prompt) method for reading in the values.
